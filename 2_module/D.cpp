...
public:
  ...
  // сложность описана в основном алгоритме r_search
...
private:
  // Сложность добавление элемента в дерево O(n*m), где n - длина слова, m -
  // количество узлов в дереве. Это связно с тем, что дети у каждого узла
  // являются по сути списком. Проход по всем узлам (братьям и детям) в
  // худшем случае и даст такую сложность
